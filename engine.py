...
def generate_recommendations(data: dict) -> dict:
    ...
    strategi = STRATEGY_BY_BUDGET.get(anggaran, STRATEGY_BY_BUDGET["Belum menentukan"])
    ...
    platform = PLATFORM_BY_AGE.get(usia, ["Instagram", "Facebook", "WhatsApp Business"])

    # q15 – Jenis Konten
    konten = CONTENT_BY_LIFESTYLE.get(gaya_hidup, [
    ...
    # q17 – Program Promo
    promo = PROMO_BY_GOAL.get(tujuan, ["Flash sale", "Promo loyalty pelanggan"])
